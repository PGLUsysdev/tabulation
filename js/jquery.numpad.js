    ...
    $.fn.numpad=function(options){
		...
		return this.each(function(){
			...
			if ($('#'+id).length == 0) {
				...
				nmpd.grid = table;
				table.append('<tbody>');
				table.append('<tr><td colspan="4" style="width: 100px;"><strong id="score-candidate-'+id+'" style="font-size: 1.1em;"></strong></td></tr>');				
				table.append('<tr><td colspan="4" style="width: 100px;"><strong id="score-criterion-'+id+'" style="font-size: 1.1em;"></strong></td></tr>');				
				table.append('<tr><td colspan="2">Minimum: <strong id="score-min-'+id+'" style="font-size: 1.1em;"></strong></td><td colspan="2">Maximum: <strong id="score-max-'+id+'" style="font-size: 1.1em;"></strong></td></tr>');				
