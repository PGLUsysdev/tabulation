...
foreach ($_POST as $adj) {
	...
	$check = $con->get(array("portion_contestant_id"=>$adj['portion_contestant_id']));
	...
	if ((isset($adj['id']))&&($adj['id'])) {
		...
		$data = array("portion_contestant_id"=>$adj['portion_contestant_id'],"points"=>$adj['adj'],"date_created"=>"CURRENT_TIMESTAMP");	
